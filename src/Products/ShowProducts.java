...
public class ShowProducts extends javax.swing.JFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      int posicion = jTable1.getSelectedRow() + 1 ;
      String direccion = Enterprise.circularList.buscarDire(posicion);
        System.out.println(direccion);
      DetallesProductos nai = new DetallesProductos();
      nai.setLocationRelativeTo(null);
      nai.setResizable(false);
      nai.nombre.setText(Enterprise.circularList.buscarNombre(posicion));
      nai.desc.setText(Enterprise.circularList.buscarDesc(posicion));
      nai.price.setText(Enterprise.circularList.buscarPrecio(posicion));
      nai.stock.setText(Enterprise.circularList.buscarStock(posicion));
       ImageIcon image = new ImageIcon(direccion);
       Icon icono = new ImageIcon(image.getImage().getScaledInstance(nai.foto.getWidth(), nai.foto.getHeight(), Image.SCALE_DEFAULT));
     
      nai.foto.setIcon(icono);
